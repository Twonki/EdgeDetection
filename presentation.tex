...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\centering
				\includegraphics[width=0.3\linewidth]{images/Kadse}
				\caption[Raw Felix]{Raw Felix}
				\label{fig:RawFelix}
			\end{figure}
			\begin{figure}
				\centering
				\includegraphics[width=0.3\linewidth]{images/KadseSimpleY}
				\caption[Felix' Y-Edges]{Felix' Y-Edges}
				\label{fig:FelixY}
			\end{figure}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\includegraphics[width=0.3\linewidth]{images/KadseSimpleX}
				\caption[Felix' X-Edges]{Felix' X-Edges}
				\label{fig:FelixX}
			\end{figure}
			\begin{figure}
				\includegraphics[width=0.3\linewidth]{images/KadseSimple}
				\caption[Felix' Edges]{Felix' Edges}
				\label{fig:FelixSimple}
			\end{figure}
		\end{column}
	\end{columns}
	\begin{center}
		Note: All images have a 50\% increased brightness
	\end{center}
\end{frame}
\subsection{Filters}
\begin{frame}
